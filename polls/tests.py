...
class QuestionModelTests(TestCase):
    ...
    def test_was_published_recently_with_future_question(self):
        """
        was_published recently() returns False for the questions whose pub_date
        is in the future.
        """
...
class QuestionIndexViewTests(TestCase): 
    ...
    def test_no_question(self):
        """
        If no questions exists, an appropriate message is dispalyed.
        """
    ...
    def test_past_question(self):
        """
        Questios with a pub_date in the past are displayed on the index page
        """
